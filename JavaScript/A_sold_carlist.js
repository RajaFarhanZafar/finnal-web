...
var sold="https://firebasestorage.googleapis.com/v0/b/showroom-21ecb.appspot.com/o/sold_out.png?alt=media&token=3244af07-94a4-40b2-a1ac-054af3405ccf";
database = firebase.database().ref();
var ref = database.child("cardetail").orderByChild("sold_status").equalTo(sold);
...
function searchBtn() {
    ...
    check1.append(check);
        ...
        var ref = database.child("cardetail").orderByChild("sold_date").equalTo(date);
